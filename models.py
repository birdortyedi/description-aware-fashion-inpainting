...
class Net(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.block_6 = PartialConv2d(in_channels=144, out_channels=128, kernel_size=3, padding=1, multi_channel=True)
        self.in_6 = nn.InstanceNorm2d(num_features=128)
        self.block_7 = PartialConv2d(in_channels=192, out_channels=128, kernel_size=3, padding=1, multi_channel=True)
        self.in_7 = nn.InstanceNorm2d(num_features=128)
        self.block_8 = PartialConv2d(in_channels=256, out_channels=128, kernel_size=3, padding=1, multi_channel=True)
        self.in_8 = nn.InstanceNorm2d(num_features=128)
        self.block_9 = PartialConv2d(in_channels=192, out_channels=128, kernel_size=3, padding=1, multi_channel=True)
        self.in_9 = nn.InstanceNorm2d(num_features=128)
        self.block_10 = PartialConv2d(in_channels=160, out_channels=64, kernel_size=3, padding=1, multi_channel=True)
        self.in_10 = nn.InstanceNorm2d(num_features=64)
        self.block_11 = PartialConv2d(in_channels=64, out_channels=3, kernel_size=3, padding=1, multi_channel=True)
