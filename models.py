...
class CoarseNet(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.block_9 = self._upsampling_in_lrelu_block(in_channels=192, out_channels=64)
        self._1x1conv_9 = self._1x1conv_lrelu_block(in_channels=64, out_channels=32)
        self.block_10 = self._upsampling_in_lrelu_block(in_channels=96, out_channels=32)
        self._1x1conv_10 = self._1x1conv_lrelu_block(in_channels=32, out_channels=16)
        self.block_11 = self._upsampling_tanh_block(in_channels=48, out_channels=3)
