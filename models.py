...
class Net(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.block_0 = PartialConv2d(in_channels=3, out_channels=32, kernel_size=7, stride=2, padding=3, bias=False, multi_channel=True, return_mask=True)
        self.block_1 = PartialConv2d(in_channels=32, out_channels=64, kernel_size=5, stride=2, padding=2, bias=False, multi_channel=True, return_mask=True)
        self.in_1 = nn.BatchNorm2d(num_features=64)
        self.block_2 = PartialConv2d(in_channels=64, out_channels=128, kernel_size=5, stride=2, padding=2, bias=False, multi_channel=True, return_mask=True)
        self.in_2 = nn.BatchNorm2d(num_features=128)
        # self.s_attention_2 = SelfAttention(in_channels=128)
        self.block_3 = PartialConv2d(in_channels=128, out_channels=64, kernel_size=5, stride=2, padding=2, bias=False, multi_channel=True, return_mask=True)
        self.in_3 = nn.BatchNorm2d(num_features=64)
        # self.s_attention_3 = SelfAttention(in_channels=64)
        self.block_4 = PartialConv2d(in_channels=64, out_channels=128, kernel_size=5, stride=2, padding=2, bias=False, multi_channel=True, return_mask=True)
        self.in_4 = nn.BatchNorm2d(num_features=128)
        self.block_5 = PartialConv2d(in_channels=128, out_channels=128, kernel_size=5, stride=2, padding=2, bias=False, multi_channel=True, return_mask=True)
        self.in_5 = nn.BatchNorm2d(num_features=128)
        ...
        self.in_6 = nn.BatchNorm2d(num_features=128)
        self.block_7 = PartialConv2d(in_channels=192, out_channels=128, kernel_size=3, padding=1, bias=False, multi_channel=True, return_mask=True)
        self.in_7 = nn.BatchNorm2d(num_features=128)
        self.block_8 = PartialConv2d(in_channels=256, out_channels=128, kernel_size=3, padding=1, bias=False, multi_channel=True, return_mask=True)
        self.in_8 = nn.BatchNorm2d(num_features=128)
        self.block_9 = PartialConv2d(in_channels=192, out_channels=128, kernel_size=3, padding=1, bias=False, multi_channel=True, return_mask=True)
        self.in_9 = nn.BatchNorm2d(num_features=128)
        self.block_10 = PartialConv2d(in_channels=160, out_channels=64, kernel_size=3, padding=1, bias=False, multi_channel=True, return_mask=True)
        self.in_10 = nn.BatchNorm2d(num_features=64)
